    ...
    <div class="container">
        ...
        @csrf
            <div class="form-group">
                ...
                <input type="text" name="kode_buku" value="{{ $data_buku->kode_buku }}" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="jumlah_halaman" min="0" value="{{ $data_buku->jumlah_halaman }}" class="form-control">
            </div>
            <div class="form-group">
                <label>ISBN</label><br>
                <input type="text" name="ISBN" value="{{ $data_buku->ISBN }}" class="form-control">
            </div>
            <div class="form-group">
